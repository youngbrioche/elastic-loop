...
The harness dominates the outcome, while the industry keeps arguing about the model. [clawbench](https://github.com/openclaw/clawbench), the agent benchmark from the OpenClaw ecosystem, takes the design stance to its conclusion: it scores the whole combination you ship, the model together with the loop and configuration around it. That argument earns its own chapter: [Harness](/harness).
