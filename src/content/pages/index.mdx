...
> **<span style="color: var(--rg-accent)">Intent</span> opens the loop. <span style="color: var(--rg-accent)">Context</span> grounds it. <span style="color: var(--rg-accent)">Backpressure</span> keeps it useful. <span style="color: var(--rg-accent)">Verification</span> closes it.**
