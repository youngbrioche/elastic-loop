...
<p class="framework-sentence">Intent <strong>opens</strong> the loop. Context <strong>grounds</strong> it. <Term id="backpressure">Backpressure</Term> <strong>keeps it useful</strong>. Verification <strong>closes</strong> it.</p>
